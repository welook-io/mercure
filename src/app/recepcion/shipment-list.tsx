              ...
              <div className="px-3 pb-3 pt-1 border-t border-neutral-100 bg-neutral-50/50">
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-700">{s.origin || '-'}</p>
                  </div>
                  <div>
                    <span className="text-xs text-neutral-500">Destino</span>
                    <p className="text-neutral-700">{s.destination || '-'}</p>
                  </div>
                  <div>
            ...
            <tbody>
              {sortedShipments.map((s) => (
                <tr key={s.id} className="border-b border-neutral-100 last:border-0 hover:bg-neutral-50">
                  ...
                  <td className="px-3 py-2 text-neutral-600 text-xs">{s.origin || <span className="text-neutral-300">-</span>}</td>
                  <td className="px-3 py-2 text-neutral-600 text-xs">{s.destination || <span className="text-neutral-300">-</span>}</td>
