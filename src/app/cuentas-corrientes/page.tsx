            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-neutral-50 border-b border-neutral-200">
                  ...
                  <th className="px-3 py-2 text-left text-xs font-medium text-neutral-500 uppercase">Remitos Pend.</th>
                  <th className="px-3 py-2 text-left text-xs font-medium text-neutral-500 uppercase">Saldo</th>
                  <th className="px-3 py-2 text-left text-xs font-medium text-neutral-500 uppercase">Última Liq.</th>
                </tr>
              </thead>
              <tbody>
